...
{
public:
	NoiseMaker(wstring SoundOutputDevice, unsigned int SampleRate = 44100, unsigned int Channels = 1, unsigned int Blocks = 8, unsigned int BlockSamples = 512)
	{
		Create(SoundOutputDevice, SampleRate, Channels, Blocks, BlockSamples);
	}
